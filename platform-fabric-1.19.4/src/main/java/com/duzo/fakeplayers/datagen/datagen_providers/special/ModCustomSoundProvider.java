...
public abstract class ModCustomSoundProvider implements DataProvider {
    protected final FabricDataOutput dataOutput;

    protected ModCustomSoundProvider(FabricDataOutput dataOutput) {
        this.dataOutput = dataOutput;
    }
    public abstract void generateSoundsData(ModCustomSoundBuilder modCustomSoundBuilder);
    @Override
