...
public class FPItems {
    ...
    public static final RegistryObject<Item> PLAYER_SHELL = ITEMS.register("player_shell", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PLAYER_AI = ITEMS.register("player_ai", () -> new Item(new Item.Properties()));
}
